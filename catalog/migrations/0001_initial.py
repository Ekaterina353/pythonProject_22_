    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='Введите название', max_length=250, null=True,
                                          verbose_name='название')),
                ('description', models.TextField(blank=True, help_text='Введите описание', max_length=250, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.CharField(blank=True, help_text='Введите цену', max_length=100, null=True,
                                           verbose_name='Цена')),
                ('created_at', models.DateField(blank=True, help_text='Введите датe создания', null=True,
